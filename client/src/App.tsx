...
const ChemistryHome = lazyRetry(() => import('./chemistry/ChemistryHome'))
const ChemistryExperimentPage = lazyRetry(() => import('./chemistry/ChemistryExperimentPage'))
const ChemistryLabPage = lazyRetry(() => import('./chemistry/ChemistryLabPage'))
const ChemistrySessionsPage = lazyRetry(() => import('./chemistry/ChemistrySessionsPage'))
      ...
      <Suspense fallback={<Loading />}>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="chemistry/sessions" element={<ChemistrySessionsPage />} />
            <Route path="chemistry/sessions/:id/report" element={<ChemistryReportPage />} />
            <Route path="chemistry/:slug/lab" element={<ChemistryLabPage />} />
            <Route path="chemistry/:slug" element={<ChemistryExperimentPage />} />
          </Route>
